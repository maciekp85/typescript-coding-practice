let array: string[] = ["Maciek", "Ela", "Jacek"];
...
console.log(`\nArray literals`)
let arrayMisc: (string | number | boolean)[] = ["string", 3, true, ];
...
let message: (string | number | boolean)[] = arrayMisc;
console.log(message);
...
let original1: number[] = Array.of(1, 2, 3);
...
let copy1: number[] = Array.from(original1);
...
console.log(`\nArray methods:`)
let data: number[] = [1, 2, 3, 4, 5], sum: number = 0;
...
let g: string[] = ["hello world", "the definitive guide"];
console.log(g);
